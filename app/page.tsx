...
const product = {"repo":"MeetingMind","suite":"AI Productivity Suite","category":"Meeting intelligence","audience":"sales teams, founders, recruiters, and client-facing operators","promise":"prepare, capture, and follow up on meetings with memory that compounds","inputLabel":"Meeting agenda, transcript, or attendee list","placeholder":"Quarterly review with ACME: renewal risk, support delays, expansion ask","primary":"Prepare meeting","gradient":"from-violet-300 via-fuchsia-300 to-sky-300","metrics":["Prep brief","Follow-ups","Memory trail"],"modules":["Attendee context","Agenda builder","Decision capture","Follow-up draft","Relationship memory"],"outputs":["Meeting brief","Questions to ask","Commitment tracker","Follow-up email"],"pricing":"Free first meeting, $29/month Pro, $149/month Revenue Team."} as const;
